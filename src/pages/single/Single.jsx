                ...
                <div className="top">
                    ...
                    <div className="item">
                        ...
                        <div className="details">
                            <h1 className="itemTitle">Jane Onail</h1>
                            <div className="detailItem">
                                <span className="itemKey">Email:</span>
                                <span className="itemValue">janeonail@gmail.com</span>
                            </div>
                            <div className="detailItem">
                                <span className="itemKey">Phone:</span>
                                <span className="itemValue">(816) 745-40-40</span>
                            </div>
                            <div className="detailItem">
                                <span className="itemKey">Addres::</span>
                                <span className="itemValue">Elton St. 2394 Garden Yd. NewYork</span>
                            </div>
                            <div className="detailItem">
